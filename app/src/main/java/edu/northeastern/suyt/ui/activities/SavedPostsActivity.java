...
import edu.northeastern.suyt.controller.SavedPostController;
...
public class SavedPostsActivity extends AppCompatActivity implements PostAdapter.OnPostClickListener {
    ...
    private SavedPostController savedPostController;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        savedPostController = new SavedPostController();
    ...
    private void loadSavedPosts() {
        // Get saved posts from controller
        List<RecyclingPost> savedPosts = savedPostController.getSavedPosts();
